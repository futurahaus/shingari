...
export class MeResponseDto {
    ...
    @ApiPropertyOptional({ example: 'Madrid', description: 'Province or state of residence' })
    provincia?: string;

    @ApiPropertyOptional({ example: 'España', description: 'Country of residence' })
    pais?: string;
    ...
    @ApiPropertyOptional({ example: 'Calle Mayor 123, Madrid', description: 'Fiscal address' })
    direccionFiscal?: string;

    @ApiPropertyOptional({ example: 'Calle Comercial 456, Madrid', description: 'Delivery address' })
    ...
    @ApiPropertyOptional({ example: true, description: 'Whether the profile is completed' })
