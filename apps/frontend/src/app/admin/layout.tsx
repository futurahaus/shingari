...
import { Home, Users, Boxes, Settings, LogOut, FolderTree, Inbox, Menu, X, Gift, Receipt, BarChart3, Images } from 'lucide-react';
...
const sidebarOptions = [
  ...
  { name: 'admin.sidebar.home_carousel', path: '/admin/home-carousel', icon: <Images className="w-5 h-5 text-gray-400" /> },
